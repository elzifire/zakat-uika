...
if (isset($_POST['hitung'])) {
    ...
    if ($hasilpanen >= 653) {
        $total = ($hasilpanen * 0.1) * $hargapanen_per_kg;
...
<h2 class="my-3">Hitung Zakat Pertanian</h2>
<hr>
<ol>
    <li>Jika hasil panen lebih dari atau sama dengan nisab 653 kg gabah, maka zakat yang dikeluarkan adalah 10% dari hasil panen.</li>
    <li>Masukan jumlah hasil panen dalam satuan Kg</li>
    <li>Masukan Harga hasil panen per Kg (rupiah)</li>
...
<div class="well">
    <form method="post" action="">
        ...
        <button type="submit" name="hitung" class="btn btn-primary">Hitung Total Harga Panen & Total Zakat yang harus dibayarkan</button>
