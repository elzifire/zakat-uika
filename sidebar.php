...
<div class="col-md-3">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <h3><?php $total = ($pemasukan - $pengeluaran);
          echo "Rp. " . rupiah($total) ?></h3>
    </div>
  </div>

  <a href="penyaluran_zakat.php" class="btn btn-block btn-primary"><span class="glyphicon glyphicon-edit"></span> Rincian Penyaluran Zakat</a>
  <br>
